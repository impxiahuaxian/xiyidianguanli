	...
	<div class="container">  
		...
		<form class="form-horizontal" role="form" id="customer_form_id">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-xs-3">
		      <input type="text" name="nickname" class="form-control required" id="nickname_id">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-xs-3">
		      <input type="text" name="password" class="form-control required" id="password_id">
		    </div>
		  </div>
	...
	jQuery.ajax({
		...
		$(function(){
			...
			jQuery.ajax( { 
				...
				success : function(obj) {
					if(obj.result){
						var customer = obj.obj;
						for(var pro in customer){
							$("#"+pro+"_id").val(customer[pro]);
							if(pro == "pic"){
								$('#head_pic_id').attr("src","../upload/download.do?fileName="+customer[pro]);
				            	$('#customer_avatar_id').val(customer[pro]);
							}
						}
					}
				},
